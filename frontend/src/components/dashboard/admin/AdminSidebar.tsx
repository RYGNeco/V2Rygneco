...
const AdminSidebar = () => {
    ...
    const menuItems = [
        ...
        { path: '/admin/metrics', label: 'Metrics', icon: RiBarChartLine },
        { path: '/admin/users', label: 'Users', icon: RiUserLine },
        { path: '/admin/settings', label: 'Settings', icon: RiSettings4Line },
    ];
        ...
        >
            ...
            <div className="border-t border-gray-100">
              ...
              ${isCollapsed ? 'w-0 opacity-0' : 'w-40 opacity-100'}`}>
                            <p className="text-sm font-medium text-gray-800 whitespace-nowrap truncate">Admin User</p>
                            <p className="text-xs text-gray-500 whitespace-nowrap truncate">admin@example.com</p>
                        </div>
                    </div>
                </div>
            </div>
